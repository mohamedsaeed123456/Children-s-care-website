            ...
            <!-- Start cSlider -->
                ...
                <div  class="container">
                 ...
                 <div style="background-color:#fcfcfc;height:150px;"class="container">
                     <br><br><br>
                   <h1 style="text-align: center;">الدورات</h1>
                </div>
            </div>
            </div>
...
<h1> الدورات المتاحة<h1>
  ...
  require 'connection.php';
          ...
          $result ="SELECT * from  circles order by id desc ";
    ...
    <br>
      <div class="about">
          <br>
        <p style="font-size:30px;">لا يوجد دورات متاحة حتي الان</p>
      </div>
           <?php } ?>
      </div>
...
<div   id="containergrid" class="row grid" >
   ...
   <div class="gg">
   <?php echo '<img class="image" src="data:image;base64 ,'.$fetch['image'].'" >';?>
  <div class="overlay1">
    <div class="text">
        <h1>تعريف للدورة</h1>
        ...
        <br><br>
        <lable>السعر بالدولار :</lable>
        
        <input style="width:250px;" type="number" placeholder="<?php echo $fetch['price'] ?>" disabled>
        <br><br>
       
        <button href="share.php">شراء</button>
