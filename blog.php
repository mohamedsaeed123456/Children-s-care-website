            ...
            <!-- Start cSlider -->
                ...
                <div  class="container">
                 ...
                 <div style="background-color:#fcfcfc;height:150px;"class="container">
                     <br><br><br>
                   <h1 style="text-align: center;">المدونة</h1>
                </div>
            </div>
            </div>
...
<h1>المقالات المتاحة<h1>
  ...
  require 'connection.php';
          ...
          $result ="SELECT * from  blog order by id desc ";
    ...
    <br>
      <div class="about">
          <br>
        <p style="font-size:30px;">لا يوجد مقالات في المدونة متاحة حتي الان</p>
      </div>
           <?php } ?>
      </div>
