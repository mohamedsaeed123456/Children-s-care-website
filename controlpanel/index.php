...
<h1>لوحة التحكم<h1>
      ...
      <br>
      <div class="about">
        <p style="font-size:30px;">هذه هي لوحة التحكم بالموقع الخاص ب مركز أنا أنموّ لرعاية الأطفال الأهلية
هنا في لوحة التحكم يستخدمها صاحب الموقع فقط ويستخدمها لاضافة الدورات للموقع التابع لهذا المركز واضافة المقالات لصفحة المدونة
</p>
      </div>
      </div>
