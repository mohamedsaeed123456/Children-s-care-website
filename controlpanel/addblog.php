...
include 'connection.php';
   ...
   $description = stripcslashes($_POST['description']);
	...
	$result = mysqli_query($link,"insert into blog (image,description) values ('$image','$description')");
         
          if($result){
        	      echo "<script>alert('تم اضافة المقال الي صفحة المدونة بنجاح')</script>";
          }
         else{
        	      echo "<script>alert('حدث خطأ ما اثناء اضافة المقالة')</script>";
          }
        }
...
<div  id="الرئيسية">
            <!-- Start cSlider -->
                ...
                <div  class="container">
                 ...
                 <div style="background-color:#e8e8e8;height:150px;"class="container">
                      <br><br><br>
                   <h1 style="text-align: center;">اضافة مقالات الي صفحة المدونة</h1>
                </div>
            </div>
            </div>
            <br><br><br>
            <div class="work">
                 <form action="" method="POST" enctype="multipart/form-data">
                    <br><br>
                    <lable class="lable">صورة للمقال (مطلوب)</lable>
                    <br>
                    <input class="input" type="file" name="image" required>
                    <br><br>
                     <lable class="lable1">نص المقال   (مطلوب)</lable>
                     <br>
                    <textarea class="textarea" name="description" type="text" required></textarea>
                    <br><br><br>
                    
                    <button name="submit" class="button">اضافة المقال</button>
                </form>
            </div>
