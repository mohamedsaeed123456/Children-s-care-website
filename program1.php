...
<?php 
  ...
  $to= "mohamedsaeed5101@gmail.com";
    ...
    . "يعتمد الطفل على نفسة في استخدام المرحاض: ". " ".$question1. "\n".
            
                "\n". "
 يعتمد الطفل على نفسة في ارتداء ملابسه :"." ".$question2 . 
 
                 "\n". " 
 يحب الطفل الاختلاط بالأخرين  :"." ".$question3.
 
 "\n" ."يتشبث الطفل برأيه كثيراً
 :" . " " .$question4 .  "\n" ."ينادى الطفل باسم غير اسمة
   :". " " .$question5. "\n" ." يعاني الطفل من تشتت الأنتباه وعدم التركيز
:". " " .$question6. "\n".

   "بيانات صحية "."\n" .
                "\n". "
هل يعاني الطفل من امراض ؟ حددي اسم المرض و تاريخ الاصابة ؟ :"." ".$question7   . "\n" ."هل يعاني الطفل من حساسية تجاه بعض الاطعمة ؟ماهي ؟ :" . " " .$question8 . "\n" ."هل يعاني الطفل من حسسايةجلدية ؟ و ما هو المسبب ؟   :". " " .$question9. "\n" ."هل يتناول الطفل ادوية طبية ؟ماهي ؟   :". " " .$question10.   "\n" .
"اجراء استلام الطفل".
"\n" . "من هو الشخص المسؤول عن استلام الطفل من المركز يومياً ؟ : ". " ".$question11   
...
."\n". "اخر(اذكره) :"." ".$other .  "\n" ."رقم الجوال :" . " " .$phone2   ;
         ...
         if(mail($to,'مركز أنا أنموّ لرعاية الأطفال الأهلية/استمارة اشتراك في برنامج الدارجين او النمو',$body)){ 
...
<div  class="col-12 col-md-12 col-lg-4 mb-4 grid-item" style="right: 0px; top: 0px;">
         <div id="card" class="card rounded-lg items ">
          <br>
                    <h1 style="color:white;text-align:right;font-size:35px;">استمارة الاشتراك  لبرنامج الدارجين والنمو<h1>
                     ...
                     <select class="i" name="question" required>
                       ...
                       <h1>بيانات عامة </h1>
                        <br><br>
                       <lable class="lable6">يعتمد الطفل على نفسة في استخدام المرحاض </lable>
                       <br>
                     <select class="i" name="question1" required>
                         <option value="">-</option>
                         <option>نعم</option>
                          <option>احيانا</option>
                           <option>لا</option>
                         </select>
                          <br><br>
                       <lable class="lable6">يعتمد الطفل على نفسة في ارتداء ملابسه</lable>
                       <br>
                     <select class="i" name="question2" required>
                         <option value="">-</option>
                         <option>نعم</option>
                          <option>احيانا</option>
                           <option>لا</option>
                          ...
                          <br><br>
                       <lable class="lable5">يحب الطفل الاختلاط بالأخرين:</lable>
                       <br>
                     <select class="i" name="question3" required>
                         <option value="">-</option>
                         <option>نعم</option>
                          <option>احيانا</option>
                           <option>لا</option>
                          ...
                          <br><br>
                       <lable class="lable5">يتشبث الطفل برأيه كثيراً</lable>
                       <br>
                     <select class="i" name="question4" required>
                         <option value="">-</option>
                         <option>نعم</option>
                          <option>احيانا</option>
                           <option>لا</option>
                          ...
                          <br><br>
                       <lable class="lable5">ينادى الطفل باسم غير اسمة</lable>
                       <br>
                     <select class="i" name="question5" required>
                         ...
                         <option>نعم</option>
                          ...
                          <br><br>
                       <lable class="lable6">يعاني الطفل من تشتت الأنتباه وعدم التركيز</lable>
                       <br>
                     <select class="i" name="question6" required>
                         <option value="">-</option>
                         <option>نعم</option>
                          <option>احيانا</option>
                           <option>لا</option>
                     ...
                     <lable class="lable4">  *من هو الشخص المسؤول عن استلام الطفل من المركز يومياً ؟</lable>
                       <br>
                     <select class="i" name="question11" required>
                         <option value="">-</option>
                         <option>الأم</option>
                          <option>الأب</option>
                        </select>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
