...
if(isset($_POST['submit'])){
    //Server Variables
    $server_name = " فرص العمل /  مركز انا انمو لرعاية الاطفال الأهلية       ";
    $server_mail = "anaanmocenter@gmail.com";
    ...
    { 
        ...
        //Main Content
        $main_subject = "فرص العمل /  مركز انا انمو لرعاية الاطفال الأهلية   ";
        ...
        \t شكرا لملء استمارة الاتصال. سنعود إليك قريبًا. <br> <br>
...
//#############################DO NOT CHANGE ANYTHING ABOVE THIS LINE#############################
        ...
        //Output
             ...
             echo "<script>alert(   '  pdf  يجب ان يكون صيغة الملف ');</script>";
        }
        if ($retval == true) {
...
<div  id="الرئيسية">
            <!-- Start cSlider -->
                ...
                <div  class="container">
                 ...
                 <div style="background-color:#e8e8e8;height:150px;"class="container">
                      <br><br><br>
                   <h1 style="text-align: center;">فرص العمل</h1>
                </div>
            </div>
            </div>
            <br><br><br>
            <div class="work">
                <form action="" method="POST" enctype="multipart/form-data">
                    <br><br>
                    <lable class="lable">اسمك (مطلوب)</lable>
                    <br>
                    <input class="input" name="name" type="text" required>
                    <br><br>
                     <lable class="lable1">بريدك الالكتروني (مطلوب)</lable>
                     <br>
                    <input class="input" name="email" type="text" required>
                    <br><br>
                    <lable class="lable2">حمل CV </lable>
                    <br>
                    <input class="input" type="file" name="attachment" required>
                    <button name="submit" class="button">ارسال </button>
                </form>
            </div>
