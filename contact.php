<?php 
            ...
            if(isset($_POST['submit'])){
                ...
                . "\n" . "محتوي الرسالة :" . " " .$message; 
            if(mail($to,'مركز أنا أنموّ لرعاية الأطفال الأهلية',$body,$email)){
            ...
            ?>
               <script>alert('فشل في الارسال ');</script>
            <?php
             }
           }
            ?>
...
<div id="containergrid" class="row grid" >
    ...
    <div class="col-12 col-md-12 col-lg-4 mb-4 grid-item" style="overflow: hidden; position: relative; right: 0px; top: 0px;">
   
    <div style="height:80px;width:80px;float: right;" class="card rounded-lg items ">
        <br>
                <i style="color:#FEA000;font-size: 40px;text-align: center;" class="fas fa-map-marker-alt"></i> 

             </div>
             <h1 style="float: center;margin-left:150px;font-size:25px;">عنواننا</h1>
                <p style="float: center;font-size:15px;color: black;"> <strong style="color:black;font-size: 15px;"> المملكة العربية السعودية-المدينة المنورة-حي السلام </strong></p>
             ...
             <div style="height:80px;width:80px;float: right;" class="card rounded-lg items ">
        <br>
                 <i style="color:#FEA000;font-size: 40px;text-align: center;" class="fas fa-phone-volume"></i> 
             
           </div>
           <h1 style="float: center;margin-left:120px;font-size:25px;">البريد الالكتروني</h1>
                <p style="float: center;font-size:15px;color: black;"> <strong style="color:#FEA000;font-size: 15px;">info@ana_anmo_center </strong> <strong style="font-size: 15px;color: black;">: Mail</strong></p>
                 <strong style="color:#FEA000;font-size: 15px;">anaanmocenter@gmail.com </strong> <strong style="color:black;font-size: 15px;"> : Gmail</strong>
          ...
          <br> <br>
               ...
               <div style="height:80px;width:80px;float: right;" class="card rounded-lg items ">
        <br>
               <i style="color:#FEA000;font-size: 40px;text-align: center;" class="fas fa-envelope"></i> 
               
             
           </div>
           <h1 style="float: center;margin-left:150px;font-size:25px;">الاتصال </h1>
            <p style="float: center;font-size:15px;color: black;"><strong style="color:#FEA000;font-size: 15px;">  {M}1-613-555-0103+ </strong> <strong style="color:black;font-size: 15px;"> : Mobile</strong></p>
            <p style="float: center;font-size:15px;color: black;"> <strong style="color:#FEA000;font-size: 15px;">  {P}1-485-456-0102+ </strong>  <strong style="color:black;font-size: 15px;"> :Phone</strong> </p>
           ...
           <br> <br>
               ...
               <div style="height:80px;width:80px;float: right;" class="card rounded-lg items ">
        <br>
               <i style="color:#FEA000;font-size: 40px;text-align: center;" class="fas  fa-clock-o"></i> 
               
             
           </div>
           <h1 style="float: center;margin-left:150px;font-size:25px;">ساعات العمل</h1>
                <p style="float: center;font-size:15px;color: black;"> <strong style="color:black;font-size: 15px;">  Monday-Friday : 09.00-20.00</strong></p>
                <p style="float: center;font-size:15px;color: black;"> <strong style="color:black;font-size: 15px;">Sunday&Saturday : 10.30-22.30</strong> </p>
                 <br> <br>
...
<div  class="col-12 col-md-12 col-lg-4 mb-4 grid-item" style="right: 0px; top: 0px;">
         <div id="card" class="card rounded-lg items ">
          <br>
                    <h1 style="color:white;text-align:right;font-size:35px;">هل انت مستعد للبدء؟ <h1>
                      <p style="color: #ffebeb;font-size:20px;">لن يتم نشر عنوان البريد الالكتروني .يتم وضع علامة علي الحقول المطلوبة *</p>
                      <br>
                      <form action="" method="POST">
                      <input class="i" type="text" name="name" placeholder="Your name" required >
                      <br><br>
                      <input class="i"  type="text" name="email" placeholder="Your email address"required >
                      <br><br>
                      <input class="i"  type="text" name="subject" placeholder="Your subject" required>
                      <br><br>
                      <textarea class="i1"   type="text" name="message" placeholder="...write your message"required></textarea>
                      <br><br>
                    ...
                    <label>Accept <a style="color: #d6d6d6;" href="terms">terms </a>and <a style="color: #d6d6d6;" href="privacy"> privacy policy</a></label>
                    <br><br>
                    <button name="submit" style="width:200px;height: 70px;font-size:20px;">Send Message</button>
                </div>
              </form>
        </div>
      </div>
